...
const defaultServices=[
 {title:"حل الواجبات والتكاليف",icon:"📝",desc:"حل واجبات وتكاليف جامعية بتنظيم واضح وتسليم مرتب.",price:"يبدأ من 39 ريال",category:"الخدمات الأكاديمية"},
 {title:"عروض PowerPoint",icon:"📊",desc:"عروض تقديمية احترافية بتصميم جذاب ومحتوى منظم.",price:"يبدأ من 49 ريال",category:"العروض والتصميم"},
 {title:"البحوث الأكاديمية",icon:"🔎",desc:"إعداد بحوث أكاديمية مع تنسيق ومراجع حسب المطلوب.",price:"يبدأ من 79 ريال",category:"الخدمات الأكاديمية"},
 {title:"مشاريع التخرج",icon:"🎓",desc:"مساعدة في مشاريع التخرج من الفكرة حتى التجهيز النهائي.",price:"حسب المشروع",category:"مشاريع التخرج"},
 {title:"التقارير المرحلية والنهائية",icon:"📘",desc:"تقارير مرحلية ونهائية للمواد والتدريب وفق تعليمات الجهة.",price:"يبدأ من 59 ريال",category:"الخدمات الأكاديمية"},
 {title:"تقارير التدريب والمواد",icon:"📄",desc:"تقارير تدريب ميداني، تدريب تعاوني، ومواد دراسية.",price:"يبدأ من 49 ريال",category:"الخدمات الأكاديمية"},
 {title:"الترجمة الأكاديمية",icon:"🌍",desc:"ترجمة عربية/إنجليزية للنصوص والملخصات والملفات الأكاديمية.",price:"حسب الكلمات",category:"اللغات والتطوير"},
 {title:"تلخيص المحتوى",icon:"🧾",desc:"تلخيص محاضرات، ملفات PDF، كتب وملازم بطريقة واضحة.",price:"يبدأ من 39 ريال",category:"الخدمات الأكاديمية"},
 {title:"خطة البحث",icon:"🧭",desc:"صياغة عنوان، مشكلة، أهداف، منهجية وخطة بحث مرتبة.",price:"يبدأ من 99 ريال",category:"مشاريع التخرج"},
 {title:"سيرة ذاتية احترافية",icon:"💼",desc:"تصميم CV احترافي بصياغة مناسبة للتقديم والتدريب.",price:"يبدأ من 49 ريال",category:"اللغات والتطوير"},
 {title:"تصميم أكاديمي وإنفوجرافيك",icon:"🎨",desc:"تصميم أغلفة، إنفوجرافيك، بوسترات وأعمال أكاديمية منظمة.",price:"يبدأ من 49 ريال",category:"العروض والتصميم"}
];
const defaultSettings={
 ...
 heroBadge:"بحوث • عروض • تقارير • مشاريع",
 heroTitle:"منصة واحدة لطلب ومتابعة خدماتك الأكاديمية باحتراف.",
 heroText:"اختر الخدمة، أرسل التفاصيل، واحصل على رقم متابعة ورسالة واتساب جاهزة للتواصل مع المختص.",
