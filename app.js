...
function etqanBuildAccountRedesign(){
  ...
  const tiles = adminMode ? [
    ["الإعدادات والثيمات","تخصيص التطبيق والثيمات المفضلة","🎨","orange","settings"],
    ["البيانات الشخصية","عرض وتعديل بياناتك الشخصية","👤","blue","profile"],
  ...
  shell.innerHTML=`
    <section class="etq-profile-card">
      <div class="etq-profile-copy">
        ...
        <p>${logged ? "استمر في التعلّم وحقق أهدافك الأكاديمية." : "سجّل الدخول للاستفادة من خدماتك وطلباتك المخصصة."}</p>
      </div>
    ...
    <section class="etq-specialist-banner">
      <div class="etq-specialist-side">
        <div class="etq-banner-icon">👤</div>
        <span class="etq-banner-arrow">‹</span>
      </div>
      <div class="etq-specialist-copy">
        <h3>${adminMode ? "لوحة المختص" : "دخول المختص"}</h3>
        <p>${adminMode ? "إدارة الطلبات، الطلاب، الرسائل والتقارير." : "إدارة الطلبات والطلاب من لوحة المختص."}</p>
        <button type="button" class="etq-light-pill" id="mobileOpenAdminBtn">${adminOpen ? "فتح لوحة المختص" : "فتح لوحة المختص"}</button>
      </div>
    </section>

    <section class="etq-grid-menu">
    ...
    ${adminMode ? `
      <section class="etq-wide-link" data-account-action="adminpanel">
        <span class="etq-arrow">‹</span>
        <div class="etq-menu-copy"><h4>لوحة المختص</h4><p>إدارة الطلبات، الطلاب، الرسائل والتقارير</p></div>
...
function etqanBuildMoreRedesign(){
  ...
  shell.innerHTML=`
    <section class="etq-profile-card">
      <div class="etq-profile-copy">
        <h3>👋 مرحبًا بك في إتقان</h3>
        <p>استمر في التعلّم، وحقق أهدافك الأكاديمية.</p>
      </div>
      <div class="etq-avatar-wrap">
