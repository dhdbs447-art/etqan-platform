...
const CACHE_NAME="etqan-1781004001";
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css?v=1781004001',
  './app.js?v=1781004001',
  './firebase-config.js?v=1781004001',
  './manifest.json?v=1781004001',
  './version.json?v=1781004001'
];
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    clients.forEach(client => client.postMessage({ type: 'ETQAN_UPDATED', version: '1781004001' }));
  })());
});
