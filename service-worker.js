...
const CACHE_NAME="etqan-1780002001";
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css?v=1780002001',
  './app.js?v=1780002001',
  './firebase-config.js?v=1780002001',
  './manifest.json?v=1780002001',
  './version.json?v=1780002001'
];
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    clients.forEach(client => client.postMessage({ type: 'ETQAN_UPDATED', version: '1780002001' }));
  })());
});
