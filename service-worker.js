...
const CACHE_NAME="etqan-1779925001";
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css?v=1779925001',
  './app.js?v=1779925001',
  './firebase-config.js?v=1779925001',
  './manifest.json?v=1779925001',
  './version.json?v=1779925001'
];
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    clients.forEach(client => client.postMessage({ type: 'ETQAN_UPDATED', version: '1779925001' }));
  })());
});
