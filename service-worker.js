...
const CACHE_NAME="etqan-1781006902";
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css?v=1781006902',
  './app.js?v=1781006902',
  './firebase-config.js?v=1781006902',
  './manifest.json?v=1781006902',
  './version.json?v=1781006902'
];
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    clients.forEach(client => client.postMessage({ type: 'ETQAN_UPDATED', version: '1781006902' }));
  })());
});
