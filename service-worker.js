...
const CACHE_NAME="etqan-1780018915";
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css?v=1780018915',
  './app.js?v=1780018915',
  './firebase-config.js?v=1780018915',
  './manifest.json?v=1780018915',
  './version.json?v=1780018915'
];
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    clients.forEach(client => client.postMessage({ type: 'ETQAN_UPDATED', version: '1780018915' }));
  })());
});
