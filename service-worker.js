...
const CACHE_NAME="etqan-1779923009";
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css?v=1779923009',
  './app.js?v=1779923009',
  './firebase-config.js?v=1779923009',
  './manifest.json?v=1779923009',
  './version.json?v=1779923009'
];
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    clients.forEach(client => client.postMessage({ type: 'ETQAN_UPDATED', version: '1779923009' }));
  })());
});
