...
const CACHE_NAME="etqan-1780001111";
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css?v=1780001111',
  './app.js?v=1780001111',
  './firebase-config.js?v=1780001111',
  './manifest.json?v=1780001111',
  './version.json?v=1780001111'
];
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    clients.forEach(client => client.postMessage({ type: 'ETQAN_UPDATED', version: '1780001111' }));
  })());
});
