...
const CACHE_NAME = 'etqan-cache-v40';
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css?v=1780202601',
  './app.js?v=1780202601',
  './firebase-config.js?v=1780202601',
  './manifest.json?v=1780202601',
  './version.json?v=1780202601',
  './assets/icon-192.png',
  './assets/icon-512.png',
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    clients.forEach(client => client.postMessage({ type: 'ETQAN_UPDATED', version: '1780202601' }));
  })());
});
