...
const CACHE_NAME="etqan-1780026814";
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css?v=1780026814',
  './app.js?v=1780026814',
  './firebase-config.js?v=1780026814',
  './manifest.json?v=1780026814',
  './version.json?v=1780026814'
];
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    clients.forEach(client => client.postMessage({ type: 'ETQAN_UPDATED', version: '1780026814' }));
  })());
});
