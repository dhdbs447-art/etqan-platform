...
const CACHE_NAME="etqan-1781003002";
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css?v=1781003002',
  './app.js?v=1781003002',
  './firebase-config.js?v=1781003002',
  './manifest.json?v=1781003002',
  './version.json?v=1781003002'
];
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    clients.forEach(client => client.postMessage({ type: 'ETQAN_UPDATED', version: '1781003002' }));
  })());
});
