...
const CACHE_NAME = 'etqan-cache-v1780183001';
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css?v=1780183001',
  './app.js?v=1780183001',
  './firebase-config.js?v=1780183001',
  './manifest.json?v=1780183001',
  './version.json?v=1780183001',
  './assets/icon-192.png',
  './assets/icon-512.png',
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    clients.forEach(client => client.postMessage({ type: 'ETQAN_UPDATED', version: '1780183001' }));
  })());
});
