...
const CACHE_NAME="etqan-1779689991";
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css?v=1779689991',
  './app.js?v=1779689991',
  './firebase-config.js?v=1779689991',
  './manifest.json?v=1779689991',
  './version.json?v=1779689991'
];
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    clients.forEach(client => client.postMessage({ type: 'ETQAN_UPDATED', version: '1779689991' }));
  })());
});
